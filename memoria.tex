...
En los últimos años, el sector tecnológico es uno de los departamentos que más crecimiento ha demostrado, consiguiendo récords de desarrollo en 2018 y 2019. Una de las ramas que se diferencian es la realidad virtual y realidad aumentada, originada en la Segunda Guerra Mundial con la necesidad de crear simuladores de vuelo para instruir a los pilotos. Es en 1960 que Morton Heilig\footnote{https://en.wikipedia.org/wiki/Morton\_Heilig} patenta el primer prototipo de visor que reproduce diapositivas en 3D  y sonidos estéreos. 

Durante décadas, los avances en este ámbito de han ido desarrollando positivamente hasta lo que tenemos actualmente:
...
Todas ellas coinciden en su sencillez para un usuario inexperto y el atractivo de imaginarte en un mundo paralelo donde puedes hacer lo que te plazca. Siguiendo las anteriores aplicaciones, muchas se encuentran en constante desarrollo y son el aliciente del surgimiento de este proyecto.
