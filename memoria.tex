...
\end{verbatim}
En este componente aparece la función "tick", la cual se ejecuta cada milisegundo, comprobando si la posición "y" del jugador es menor (para así saber si ha caído) y haciendo que reaparezca en el inicio. Los componentes son herramientas muy potentes, ya que nos permiten crear funciones complejas como esta y simplifica el código. Para asociar un componente a una entidad debemos añadirlo como ya hemos visto anteriormente como un atributo cualquiera.

\subsection{Funcionalidades añadidas}
Siguiendo todo lo comentado en el anterior apartado, se añadieron unas funcionalidad no tan básicas para complementar el juego.
\begin{itemize}
	...
	\item Efectos de sonido. Se añadieron efectos de sonido en el evento final del juego, al abrir puertas o al detener el bloque.
	\item Gafas VR. Por último, se adecuó el minijuego para poder jugarlo con las gafas de realidad virtual. Para ello, se necesitaron nuevos componentes que representasen nuestras mando en la escena y pudiesemos usarlas como si fuesen el ratón. Este componente podemos encontrarlo su propia página de GitHub\footnote{https://github.com/wmurphyrd/aframe-super-hands-component}.
\end{itemize}
