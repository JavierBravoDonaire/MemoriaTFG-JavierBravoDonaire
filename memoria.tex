...
Fusionando los elementos HTML con el lenguaje JavaScript, podemos manejar distintos eventos y crear funcionalidad, que añaden dinamismo a la escena. A-Frame, el cual está construido sobre Three.js, se encargará de generar el entorno, y agregando la biblioteca WebGL se renderizarán todos los elementos.
...
Para esta tarea, se crea una función que genera lineas en los distintos plano hasta una distancia que se le pasa como parámetro, por si queremos hacerlo más grande o pequeño, creando así la cuadrícula y el eje 'y'. Además, para que es modo se diferencie y deje apreciar bien los ejes, se cambia la textura del suelo por un color verde que resalte el negro de los ejes.

Para alternar entre la escena en su estado normal de su modo edición, se establecen dos teclas del teclado:
...
Con todos estos cambios, se logra adaptar la versión de escritorio a cualquier dispositivo declarados anteriormente.

\subsection{Resultado}

Se consigue así la versión final de este proyecto, logrando todas las funcionalidades propuestas con éxito. El código HTML de las dos versiones se adjunto anteriormente, pero el código JavaScript\footnote{https://github.com/JavierBravoDonaire/A-frame/blob/master/Sprint\%204/improve.js} se adjunta en este apartado. Tanto la versión de escritorio como de gafas, usan el mismo JavaScript con el objetivo de lograr una unificación de ambas, en el caso que sea necesario. Por último, la versión final del proyecto se encuentra alojada en el repositorio de GitHub para su libre uso, en versión de escritorio\footnote{https://javierbravodonaire.github.io/A-frame/Sprint\%204/desktop.html} y versión VR\footnote{https://javierbravodonaire.github.io/A-frame/Sprint\%204/glasses.html}.
